...
# Validity
VF_14   = '2026-06-01'; VT_14   = '2026-06-14'   # EA/SA/IO/WA/ECSA/WCSA
VF_END  = '2026-06-01'; VT_END  = '2026-06-30'   # MELL/SPI
...
lines = []
lines.append("-- ================================================================")
lines.append("-- PIL (India) Pvt. Ltd. — NHAVA SHEVA Multi-Trade June 2026")
...
lines.append("-- Valid 01-14 Jun: EA/SA/IO/WA/ECSA/WCSA")
lines.append("-- Valid 01-30 Jun: MELL / South Pacific Islands")
...
# ============================================================
lines.append("-- ======== EAST AFRICA (01-14 Jun 2026 | EBS $160/teu extra) ========")
lines.append("")
lines.append(ea('Kenya',          'MOMBASA',           3050,  4300))
lines.append(ea('Tanzania',       'DAR ES SALAAM',     2850,  3900))
lines.append(ea('Tanzania',       'ZANZIBAR',          4050,  6500, 'MOMBASA', 'via Singapore/Mombasa'))
lines.append(ea('Mozambique',     'BEIRA / MAPUTO',    3250,  4600))
lines.append(ea('Mozambique',     'NACALA',            3250,  4600))
lines.append("")

# ============================================================
# SOUTH AFRICA (01-14 Jun 2026 | EBS $160/TEU extra)
# ============================================================
lines.append("-- ======== SOUTH AFRICA (01-14 Jun 2026 | EBS $160/teu extra) ========")
lines.append("")
lines.append(sa('South Africa',   'DURBAN',            2050,  2400))
lines.append(sa('South Africa',   'CAPE TOWN',         2150,  2600))
lines.append("")

# ============================================================
# INDIAN OCEAN (01-14 Jun 2026 | EBS $160/TEU extra)
# ============================================================
lines.append("-- ======== INDIAN OCEAN (01-14 Jun 2026 | EBS $160/teu extra) ========")
lines.append("")
lines.append(io('Mauritius',      'PORT LOUIS',        2400,  2900))
lines.append(io('France',         'REUNION (POINTE DES GALETS)', 2400, 2900))
lines.append(io('Madagascar',     'TAMATAVE',          2650,  3700))
lines.append("")

# ============================================================
# WEST AFRICA (01-14 Jun 2026 | EBS inclusive)
# ============================================================
lines.append("-- ======== WEST AFRICA (01-14 Jun 2026 | EBS inclusive) ========")
lines.append("")
lines.append(wa('Nigeria',        'ONNE',              3400,  4900))
lines.append(wa('Nigeria',        'APAPA (LAGOS)',      3400,  4900))
lines.append(wa('Togo',           'LOME',              3000,  4500))
lines.append(wa('Ghana',          'TEMA',              3000,  4500))
lines.append(wa("Ivory Coast",    'ABIDJAN',           3050,  4600))
lines.append(wa('Benin',          'COTONOU',           3100,  4700, 'LOME', 'via Singapore & Lome'))
lines.append(wa('Cameroon',       'DOUALA',            3500,  5100, 'LOME', 'via Singapore & Lome'))
lines.append("")

# ============================================================
# EAST COAST SOUTH AMERICA (01-14 Jun 2026 | EBS $160/TEU extra)
# ============================================================
lines.append("-- ======== ECSA (01-14 Jun 2026 | EBS $160/teu extra) ========")
lines.append("")
lines.append(ecsa('Brazil',       'SANTOS',            6000,  6300))
lines.append(ecsa('Brazil',       'PARANAGUA',         6000,  6300))
lines.append(ecsa('Uruguay',      'MONTEVIDEO',        6000,  6300))
lines.append(ecsa('Argentina',    'BUENOS AIRES',      6000,  6300))
lines.append(ecsa('Brazil',       'NAVEGANTES',        6000,  6300))
lines.append(ecsa('Brazil',       'RIO DE JANEIRO',    6000,  6300))
lines.append(ecsa('Brazil',       'ITAPOA',            6000,  6300))
lines.append("")

# ============================================================
# WEST COAST SOUTH AMERICA (01-14 Jun 2026 | EBS incl, LSR $160/TEU extra)
# ============================================================
lines.append("-- ======== WCSA (01-14 Jun 2026 | EBS incl | LSR $160/teu extra) ========")
lines.append("-- Rows 1-8 via Shanghai | Rows 9-12 via Ningbo")
lines.append("")
lines.append(wcsa('Mexico',       'MANZANILLO',        4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Mexico',       'LAZARO CARDENAS',   4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Ecuador',      'GUAYAQUIL',         4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Colombia',     'BUENAVENTURA',      4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Peru',         'CALLAO',            4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Chile',        'VALPARAISO',        4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Chile',        'SAN ANTONIO',       4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Mexico',       'ENSENADA',          4100,  4400, 'SHANGHAI'))
lines.append(wcsa('Guatemala',    'PUERTO QUETZAL',    5100,  5400, 'NINGBO'))
lines.append(wcsa('Costa Rica',   'PUERTO CALDERA',    5100,  5400, 'NINGBO'))
lines.append(wcsa('El Salvador',  'ACAJUTLA',          5100,  5400, 'NINGBO'))
lines.append(wcsa('Nicaragua',    'CORINTO',           5100,  5400, 'NINGBO'))
lines.append("")

# ============================================================
# MELL PORTS — PNG / AUS / Timor-Leste / Marshall Islands
# (01-30 Jun 2026 | RRS $750/20' $1500/40' extra)
# ============================================================
lines.append("-- ======== MELL PORTS (01-30 Jun 2026 | RRS $750/20 $1500/40 extra) ========")
lines.append("")
...
# (01-30 Jun 2026 | LSR $292/20' $584/40' | EIS $150/20' $300/40')
# ============================================================
lines.append("-- ======== SOUTH PACIFIC ISLANDS (01-30 Jun 2026) ========")
lines.append("-- LSR $292/20 $584/40 | EIS $150/20 $300/40 | all via Singapore & Auckland")
lines.append("")
# Nukualofa=Tonga, Apia=Samoa — different countries; split into separate rows same rate
...
lines.append(spi('Tuvalu',           'FUNAFUTI',           6900, 13800, 'AUCKLAND', 'via Singapore & Auckland'))
