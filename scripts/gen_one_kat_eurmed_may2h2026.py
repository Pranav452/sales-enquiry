...
EUR_CLAUSES = (
    ...
    "|Validity: 16-31 May 2026 (vessel basis; Gate In date)"
    "|Rates inclusive of: CAF, CSS, HEA, MBS"
    "|Sub to: OBS USD 117/TEU | EFS USD 120/TEU | EES USD 95/TEU (not applicable UK ports)"
...
MED_CLAUSES = (
    ...
    "|Sub to: OBS USD 119/TEU | EFS USD 120/TEU | EES USD 182/TEU"
...
# EES not applicable for UK ports
SURCH_EUR     = 'OBS:117/teu;EES:95/teu;EFS:120/teu;ESD:35/bl;SLF:collect;THC:collect;CAF:incl;CSS:incl;HEA:incl;MBS:incl'
SURCH_EUR_UK  = 'OBS:117/teu;EFS:120/teu;ESD:35/bl;SLF:collect;THC:collect;CAF:incl;CSS:incl;HEA:incl;MBS:incl'
SURCH_MED     = 'OBS:119/teu;EES:182/teu;EFS:120/teu;ESD:35/bl;HEA:300/20D>16mt-600/20D>18mt;THC:collect;CAF:incl;CSS:incl;MBS:incl'

NOTES_EUR    = 'Incl CAF,CSS,HEA,MBS; OBS $117/teu; EES $95/teu (not UK); EFS $120/teu; ESD $35/BL; SLF+THC+Docs extra; CY/CY'
NOTES_EUR_UK = 'Incl CAF,CSS,HEA,MBS; OBS $117/teu; EFS $120/teu; ESD $35/BL; EES N/A (UK); SLF+THC+Docs extra; CY/CY'
NOTES_MED    = 'Incl CAF,CSS,MBS; OBS $119/teu; EES $182/teu; EFS $120/teu; ESD $35/BL; HEA $300/20D>16MT or $600/20D>18MT extra; THC+Docs extra; CY/CY'
...
def row(dc, dp, r20, r40, surcharges, notes, clauses):
    ...
    return (
        ...
        f"VALUES ('{SL}','India','{OP}','{esc(dc)}','{esc(dp)}',"
        f"'USD',{r20},{r40},'{VF}','{VT}',NULL,'{s}','{n}','{cl}','{PDF_URL}',1,'SYSTEM',GETDATE(),GETDATE());\nGO"
    )

def eur(dc, dp, r20, r40hq, uk=False, r40gp=None):
    # r40gp only passed when 40GP != 40HQ; stored value = 40HQ
    n = NOTES_EUR_UK if uk else NOTES_EUR
    if r40gp and r40gp != r40hq:
        n += f'; 40GP=${r40gp}'
    s = SURCH_EUR_UK if uk else SURCH_EUR
    return row(dc, dp, r20, r40hq, s, n, EUR_CLAUSES)
...
lines.append("-- Validity: 16-31 May 2026 | Vessel basis")
lines.append("-- Origin: Kattupalli (INKAT)")
lines.append("-- EUROPE: Incl CAF,CSS,HEA,MBS | Extra: OBS $117 EES $95 EFS $120 ESD $35 SLF THC Docs")
lines.append("-- MED:    Incl CAF,CSS,MBS      | Extra: OBS $119 EES $182 EFS $120 ESD $35 HEA THC Docs")
lines.append("-- Note: EES not applicable for UK ports")
lines.append("-- Note: 40'HQ rate stored as RATE_40; where 40GP differs, noted in NOTES")
lines.append("-- ================================================================")
lines.append("")
...
# ============================================================
# EUROPE — 16-31 May 2026
# Rate sheet has 20'GP / 40'GP / 40'HQ; RATE_40 = 40'HQ
# ============================================================
lines.append("-- ======== EUROPE (16-31 May 2026) ========")
lines.append("")

lines.append("-- North Europe hubs (shared rate: 1630/1365)")
...
lines.append("-- Sweden")
lines.append(eur('Sweden',      'GAVLE',                      1930, 1815, r40gp=1915))   # 40GP=1915 40HQ=1815
...
lines.append(eur('Finland',     'OULU',                       2990, 2965, r40gp=3565))   # 40GP=3565 40HQ=2965
...
# ============================================================
# MED — 16-31 May 2026
# Rate sheet has 20'GP / 40'HQ only; RATE_40 = 40'HQ
# ============================================================
lines.append("-- ======== MED (16-31 May 2026) ========")
lines.append("")
