...
lines = []
lines.append("-- ============================================================")
lines.append("-- ONE (Ocean Network Express) - Europe & MED Rates Apr 2H 2026")
lines.append("-- Validity: 22-30 Apr 2026 (NSA Handover / Gate In date)")
...
lines.append("")
lines.append(row('Netherlands', 'ROTTERDAM',        1735, 1460, SURCH_EUR, NOTES_EUR))
lines.append(row('Belgium',     'ANTWERP',           1735, 1460, SURCH_EUR, NOTES_EUR))
lines.append(row('Germany',     'HAMBURG',           1735, 1460, SURCH_EUR, NOTES_EUR))
lines.append("")

lines.append("-- ======== MED (IOM service) - BCN / VLC / GOA ========")
lines.append("")
lines.append(row('Spain',  'BARCELONA', 2025, 1755, SURCH_MED, NOTES_MED))
lines.append(row('Spain',  'VALENCIA',  2025, 1755, SURCH_MED, NOTES_MED))
lines.append(row('Italy',  'GENOVA',    2025, 1755, SURCH_MED, NOTES_MED))
lines.append("")
